...
# Create model
ae = AE(36, std_param=5, batch_size=100,
        num_epochs=30, normalize=False)
sda = SDA(num_input=12, num_units=4, num_steps=3, batch_size=100,
          normalize=False, std_param=8, num_epochs=10, debug=False)
...
with open('data/classifier_test.csv', 'w') as f:
